  ...
  computed: {
    buttonClasses() {
      const variants = {
        ...
        primary: 'bg-blue-100 text-blue-700 border-blue-300 hover:bg-blue-200 hover:border-blue-400 dark:bg-blue-900/20 dark:text-blue-400 dark:border-blue-800 dark:hover:bg-blue-900/30',
    ...
    rippleColor() {
      const colors = {
        ...
        primary: 'rgba(59, 130, 246, 0.3)',  // blue-500 with opacity
